...
<html>
   <head>
      ...
      <script src="<g:resource dir="js" file="ChatServiceHost.js" />"></script>
   ...
   <input id = "userDisplayName" type="hidden" value="${session.displayName}">
      ...
      <div id='cssmenu'>
         <img style = "position: absolute; left: 8px; top: 6px; width: 120px;" src = "/SonicChatV1/static/images/sonicLogo.png">
         <ul>
      ...
      <div class = "main" style = "margin: 0 auto;  width: 1105px; height: 500px;">
         <div style = "display: inline-block; float: left; width: 220px; ">
           ...
           <div style = " margin:auto; margin-top: 13px;  width: 150px; vertical-align: top;" >  <img src = "/SonicChatV1/static/images/greenStatus.png" style = "width: 16px; vertical-align: top; "> <p style = "display: inline-block; vertical-align: top;  margin: 0px 0px 10px 5px; font-color: #3C3C3C; font-size: 15px;"> <b>Accepting Chats</b></p></div>
             </div>
            <!-- Status -->
            ...
            <div class = "userConnections" id = "userConnections" >
	            ...
	            <div style = "margin-top: 0px; height: 50px;   background-color: #f4f4f4;  text-align: center;  border-top: solid 1px; border-color: #bdbdbd; ">
	               <img src = "/SonicChatV1/static/images/icons/transfer.png" style = "margin: 6px 13px 0px; width: 35px; display:inline-block;">
	               <img src = "/SonicChatV1/static/images/icons/end.png" style = "margin: 6px 13px 0px; width: 35px; display:inline-block;">
	               <img src = "/SonicChatV1/static/images/icons/settings.png" style = "margin: 6px 13px 0px; width: 35px;  display:inline-block;">
	            </div>
	            <!-- Status -->
            </div>	
         </div>
