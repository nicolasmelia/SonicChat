  ...
  <div id='cssmenu' style = "min-width: 1000px;">
      ...
      <div class = "main" style = "margin: 0 auto;  width: 1105px; height: 500px;">
         <div style = "display: inline-block; float: left; width: 220px; ">
           ...
           <div style = " margin:auto; margin-top: 13px;  width: 150px; vertical-align: top;" >  <img  src="${resource(dir:'images',file:'greenStatus.png')}"  style = "width: 16px; vertical-align: top; "> <p style = "display: inline-block; vertical-align: top;  margin: 0px 0px 10px 5px; font-color: #3C3C3C; font-size: 15px;"> <b>Accepting Chats</b></p></div>
             </div>
            <!-- Status -->
            ...
            <div class = "userConnections" id = "userConnections" >
	            ...
	            <div style = "margin-top: 0px; height: 50px;   background-color: #f4f4f4;  text-align: center;  border-top: solid 1px; border-color: #bdbdbd; ">
	               <img class = "imgButton"  id = "endChat" onClick = "endClientsChat()" src = "${resource(dir:'images/icons',file:'end.png')}" style = "margin: auto; margin-top: 8px; width: 35px;  padding-left: 70px;  padding-right: 70px; display:block;">
	            </div>
	            <!-- Status -->
            </div>	
         </div>
