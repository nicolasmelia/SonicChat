...
printHtmlPart(13)
invokeTag('formatDate','g',53,['format':("MM-dd-yyyy"),'date':(message.date)],-1)
printHtmlPart(14)
...
invokeTag('captureBody','sitemesh',103,['style':("")],1)
printHtmlPart(18)
}
...
public static final long LAST_MODIFIED = 1438570495609L
